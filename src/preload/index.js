...
const api = {
  ...
  createProduct: (productData) => ipcRenderer.invoke('api:createProduct', productData),
  updateProduct: (productId, productData) => ipcRenderer.invoke('api:updateProduct', productId, productData),
  deleteProduct: (productId) => ipcRenderer.invoke('api:deleteProduct', productId),
